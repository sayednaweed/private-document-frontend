...
export function UserTable() {
  ...
  const [users, setUsers] = useState<{
    filterList: PaginationData;
    unFilterList: PaginationData;
  }>({
    filterList: {
      data: [],
      lastPage: 1,
  ...
  return (
    <>
      ...
      <Table className="bg-card rounded-md my-[2px] py-8 w-full table-fixed">
        <TableHeader className="rtl:text-3xl-rtl ltr:text-xl-ltr">
          <TableRow className="hover:bg-transparent">
            <TableHead className="text-center px-0 w-[70px]">
              {t("Profile")}
            </TableHead>
            <TableHead className="text-start px-1 w-[150px]">
              {t("username")}
            </TableHead>
            <TableHead className="text-start px-1 w-[180px]">
              {t("role")}
            </TableHead>
            <TableHead className="text-start px-1 w-[180px]">
              {t("email")}
            </TableHead>
            <TableHead className="text-start px-1 w-[120px]">
              {t("contact")}
            </TableHead>
            <TableHead className="text-start px-1 w-[120px]">
              {t("Join date")}
